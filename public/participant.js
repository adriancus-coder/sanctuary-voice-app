...
const LIVE_ENTRY_MIN_DISPLAY_MS = 4000;   // PARTICIPANT-DISPLAY-LONGER-V2 (era 3000; SLOWER-DISPLAY era 2200)
const LIVE_ENTRY_MAX_DISPLAY_MS = 12000;  // PARTICIPANT-DISPLAY-LONGER-V2 (era 11000; SLOWER-DISPLAY era 9000)
...
function getLiveEntryDuration(entry) {
  ...
  const readingMs = 1400 + (words * 550) + (lineCount * 360);   // PARTICIPANT-DISPLAY-LONGER-V2 (per-cuvânt 450→550; baza 1400 + per-linie 360 neschimbate)
